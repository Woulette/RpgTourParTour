export default {
  ...
  loot: [
    ...
    { itemId: "amulette_corbeau_eau", min: 1, max: 1, dropRate: 0.04 },
    { itemId: "ceinture_corbeau_eau", min: 1, max: 1, dropRate: 0.04 },
    { itemId: "bottes_corbeau_eau", min: 1, max: 1, dropRate: 0.04 },
    { itemId: "anneau_corbeau_eau", min: 1, max: 1, dropRate: 0.04 },
  ],
  xpReward: 20,
  goldRewardMin: 8,
  goldRewardMax: 21,
