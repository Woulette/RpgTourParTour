export default {
  ...
  loot: [
    ...
    { itemId: "coiffe_corbeau_air", min: 1, max: 1, dropRate: 0.02 },
    { itemId: "cape_corbeau_air", min: 1, max: 1, dropRate: 0.02 },
    { itemId: "amulette_corbeau_air", min: 1, max: 1, dropRate: 0.02 },
    { itemId: "ceinture_corbeau_air", min: 1, max: 1, dropRate: 0.02 },
    { itemId: "bottes_corbeau_air", min: 1, max: 1, dropRate: 0.02 },
    { itemId: "anneau_corbeau_air", min: 1, max: 1, dropRate: 0.02 },
  ],
  xpReward: 20,
  goldRewardMin: 8,
  goldRewardMax: 21,
