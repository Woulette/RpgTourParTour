import { ensureBijoutierState, addBijoutierXp } from "../../metier/bijoutier/state.js";
...
function renderRecipes(player, selectedIdRef) {
  ...
  let currentSelected = selectedIdRef?.value || (bijoutierRecipes[0] && bijoutierRecipes[0].id);

  bijoutierRecipes.forEach((recipe) => {
