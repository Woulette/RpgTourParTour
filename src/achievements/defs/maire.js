export const maireAchievements = [
  ...
  {
    id: "maire_etape_2_cazard",
    category: "quetes",
    title: "Ordres du maire - Cazard",
    description: "Completer la mission de cazards pour le maire.",
    requirements: [{ type: "quest_completed", questId: "maire_cazard_1" }],
    rewards: { xpPlayer: 90, gold: 40, honorPoints: 8 },
  },
  {
    id: "maire_global",
    category: "quetes",
    ...
    requirements: [
      ...
      { type: "achievement_unlocked", achievementId: "maire_etape_2_cazard" },
    ],
