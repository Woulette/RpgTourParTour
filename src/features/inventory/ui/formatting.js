...
export function decorateBonusHtml(text) {
  ...
  const patterns = [
    ...
    { label: "Dommage Feu", cls: "inventory-bonus-stat-feu" },
    { label: "Dommage Eau", cls: "inventory-bonus-stat-eau" },
    { label: "Dommage Air", cls: "inventory-bonus-stat-air" },
    { label: "Dommage Terre", cls: "inventory-bonus-stat-terre" },
