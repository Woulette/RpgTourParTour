...
import { getAchievementProgress } from "../runtime/index.js";
import { achievementPackDefs } from "../defs/index.js";
...
function update(player) {
  ...
  const claimables = computeClaimable(currentPlayer);
  ...
  btn.onclick = () => {
    ...
    openAchievementClaimPanel(currentPlayer);
  };
}
