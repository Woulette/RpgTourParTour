        ...
        <section class="craft-left craft-left-alchimiste">
          ...
          <div class="craft-recipe-filters">
            <input
              ...
              id="bucheron-filter-level"
              placeholder="Niv. max"
            />
            <input
              type="text"
              class="craft-filter-search"
              id="bucheron-filter-search"
              placeholder="Rechercher..."
            />
            <select class="craft-filter-type" id="bucheron-filter-type">
...
function getRecipeFilters() {
  const levelInput = panelEl.querySelector("#bucheron-filter-level");
  const searchInput = panelEl.querySelector("#bucheron-filter-search");
  const typeSelect = panelEl.querySelector("#bucheron-filter-type");
...
function getFilteredRecipes() {
  ...
  const sortedRecipes = bucheronRecipes.slice().sort((a, b) => {
